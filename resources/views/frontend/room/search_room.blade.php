            ...
            <div class="row pt-45">
                ...
                @foreach ($rooms as $item)
                    @php
                        ...
                        // here av_room means available room  
                    ...
                    @if ($av_room > 0 && old('persion') <= $item->total_adult)
                        <div class="col-lg-4 col-md-6">
                            <div class="room-card">
                                  {{-- '?check_in=' . old('check_in') . '&check_out=' . old('check_out') . '&persion=' . old('persion') ye sab optional h ? ke sab url me dikhenge  --}}
                                <a
                                ...
                                <div class="content">
                                    ...
                                    <ul>
                                        <li class="text-color">{{getCurrencyIcon()}}{{ $item->price }}</li>
