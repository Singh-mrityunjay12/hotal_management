...
@section('main')
    ...
    <script>
        ...
        function price_calculate(total_nights) {
            ...
            var d = (parseInt(discount_p) / 100) * sub_total;
            var d1 = d.toString();
            var discount_price = parseFloat(d1).toFixed(2);

            var total_price=(parseInt(sub_total - discount_price));
            
            $(".t_subtotal").text(sub_total);
            $(".t_discount").text(discount_price);
            $(".t_g_total").text(total_price);
