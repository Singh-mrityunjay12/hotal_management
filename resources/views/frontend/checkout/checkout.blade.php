                                ...
                                <div class="billing-details">
                                    ...
                                    <table class="table" style="width: 100%">
                                        @php
                                            ...
                                            $total_price = intval($subtotal - $discount);
                                        @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right">
                                                <p>{{getCurrencyIcon()}}{{ $total_price }}</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <div class="payment-method">
                                ...
                                <p>
                                    <input type="radio"  id="stripe" name="payment_method"
                                        value="Stripe">
                                    <label for="stripe">Razorpay</label>
                                </p>
                                ...
                                {{-- <div id="stripe_pay" class="d-none"> --}}
                                    ...
                                    $payableAmount = round($total_price * 1, 2);
                ...
                if (pay_method == undefined) {
                    ...
                    if (!$form.data('cc-on-file')) {
                        ...
                        Stripe.setPublishableKey(
                            "pk_test_51QR5xtKuVTLwN4BNuHI9x75hu8aYLFsonSFQRxt7MsAZCGaKgCkpUVjcdksjEsddmWGk1fTFyPcBWAOco2eQAAvI00zRaLdviJ"
                            );
                        Stripe.createToken({
