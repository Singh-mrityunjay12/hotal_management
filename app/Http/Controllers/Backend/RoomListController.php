...
class RoomListController extends Controller
{
    ...
    public function ViewRoomList(){
        ...
        // $room_number_list = RoomNumber
         ...
         ->leftJoin('bookings','bookings.id','booking_room_lists.booking_id') //booking_room_lists ka sara data ayega and bookings ka vo data jo dono me match kar raha ho  vo ayega
         ->select(
            'room_numbers.*',
