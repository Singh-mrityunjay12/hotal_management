...
use App\Http\Controllers\Backend\AboutCotroller;
...
use App\Http\Controllers\Backend\RoomRviewsController;
...
Route::middleware(['auth','IsRole:admin'])->group(function(){
...
// });
 ...
 Route::controller(BookingController::class)->group(function(){
   ...
   /// Admin Room List All Route  Smtp setting (mail setting )
 Route::controller(SettingController::class)->group(function(){
...
//Razorpay Setting Route 
Route::controller(RazorpaySettingController::class)->group(function(){

    Route::get('/razorpay-setting', 'index')->name('razorpay.index'); 

    Route::put('razorpay-setting-update/{id}','update')->name('razorpay-setting.update');
...
Route::controller(QuestionController::class)->group(function(){
  ...
  Route::get('/question','question')->name('question.index');
  ...
  Route::put('/update/question/{id}','updateQuestion')->name('update.question');
...
Route::controller(RoomRviewsController::class)->group(function(){

    Route::get('/room/reviews','index')->name('reviews.index');
    Route::put('room/reviews/change-status',  'changeStatus')->name('reviews.change-status');
...
Route::controller(BookingController::class)->group(function(){
   ...
   Route::get('/user/check', 'UserChecking')->name('user.checking');
...
Route::controller(BookingController::class)->group(
    function(){
        Route::get('/razorpay/payment', 'payment')->name('razorpay.payment');
        Route::post('razorpay/payment','payWithRazorPay')->name('razorpay.payment1');
    }
);
...
Route::controller(AboutCotroller::class)->group(function(){
    
    // Route::get('/admin/about/page','aboutPage')->route('admin.about.page');
    
    Route::get('/create/about','CreateAbout')->name('create.about.page');

    Route::put('about/page/update','update')->name('about.page.update');
...
Route::controller(GalleryController::class)->group(function(){
    ...
    Route::get('about/page','AboutUs')->name('about.page');
